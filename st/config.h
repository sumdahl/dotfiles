 ...
 */
static char *font = "JetBrainsMono Nerd Font:style:medium:size=13:antialias=true:autohint=true";
static char *font2[] = { "JetBrainsMono Nerd Font :pixelsize=11:antialias=true:autohint=true" };
