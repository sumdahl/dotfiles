...
static const char *fonts[] = {"JetBrainsMono Nerd Font:style:medium:size=11", "JetBrainsMono Nerd Font:style:medium:size=11", "Material Design Icons Desktop:size=9"};
...
static const char *tags[] = {"", "", "3", "", "5", "󰓇", " ", "8", "9"};
...
//to control brightness
    // {0, XF86XK_MonBrightnessUp,         spawn, SHCMD("~/.local/bin/ChangeBrightnes up")},
    // {0, XF86XK_MonBrightnessDown,         spawn, SHCMD("~/.local/bin/ChangeBrightnes down")},
