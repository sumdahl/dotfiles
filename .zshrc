...
export EDITOR=nvim
alias n='nvim'
alias viber='viber & disown'
alias rm='trash'
alias v='vim'
alias purga='sudo pacman -R $(pacman -Qdt | awk '{print S1}')'
alias mpvh='mpv-handler'
alias prof='powerprofilesctl get'
alias perf='powerprofilesctl set performance'
alias perf='powerprofilesctl set performance'
alias perf='powerprofilesctl set performance'
alias batt='powerprofilesctl set power-saver'
alias bala='powerprofilesctl set balanced'
alias zt='zathura'
...
source /home/sumdahl/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh
source ~/powerlevel10k/powerlevel10k.zsh-theme
